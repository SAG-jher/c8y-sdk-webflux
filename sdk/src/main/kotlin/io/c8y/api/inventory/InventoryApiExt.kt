...
fun InventoryApi.ensureExistsByType(type: String,name: String,configure: ManagedObject.()->ManagedObject): Mono<ManagedObject> {
...
fun InventoryApi.listGroups(vararg params: Pair<String, Any>  ) =
    this.list("fragmentType" to "c8y_IsDeviceGroup", *params, "withChildren" to "false")
fun InventoryApi.listDevices(vararg params: Pair<String, Any>  ) =
    this.list("fragmentType" to "c8y_IsDevice", *params, "withChildren" to "false")

fun InventoryApi.ensureGroup(name: String = "c8y_test", requiredInterval: Long = -1): Mono<ManagedObject> {
...
fun InventoryApi.ensureDevice(type: String = "c8y_test",
                              name: String = "Test Device",
                              requiredInterval: Long = -1,
                              vararg fragments:Pair<String,Any>): Mono<ManagedObject> {
